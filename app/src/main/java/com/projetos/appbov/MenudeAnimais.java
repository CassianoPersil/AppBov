...
public class MenudeAnimais extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton iconmensagem = (FloatingActionButton) findViewById(R.id.iconmensagem);
        iconmensagem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Snackbar.make(view, "Nos envie um email", Snackbar.LENGTH_LONG)
